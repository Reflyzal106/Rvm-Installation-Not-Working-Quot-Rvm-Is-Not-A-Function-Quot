# [SOLVED] Rvm Installation Not Working Quot Rvm Is Not A Function Quot
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/rvm-installation-not-working-quot-rvm-is-not-a-function-quot)

---

### 🔍 Quick Technical Overview & Summary:
Check if the RVM installation is correct by running 'rvm install ruby' and then try to use a specific version with 'rvm use <version>'.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/rvm-installation-not-working-quot-rvm-is-not-a-function-quot)**
